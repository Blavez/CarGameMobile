...
namespace BattleScripts
{
    public class MainWindowObserver : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _wantedLevel = CreateDataPlayer(DataType.WantedLevel);
        ...
        private void OnDestroy()
        {
            ...
            DisposeDataPlayer(ref _wantedLevel);
        ...
        private void IncreaseWantedLevel() => IncreaseValue(ref _allCountWantedLevelPlayer, DataType.WantedLevel);
        private void DecreaseWantedLevel() => DecreaseValue(ref _allCountWantedLevelPlayer, DataType.WantedLevel);
        ...
        private void AddToValue(ref int value, int addition, DataType dataType)
        {
            ...
            if (_allCountWantedLevelPlayer >= 3)
        ...
        private DataPlayer GetDataPlayer(DataType dataType) =>
            dataType switch
            {
                ...
                DataType.WantedLevel => _wantedLevel,
                _ => throw new ArgumentException($"Wrong {nameof(DataType)}")
            };
        ...
        private void Go()
        {
            Debug.Log("You have left the enemy");
        }

        public void ChangeStateOfButton(bool flag)
        {
            if (flag)
